...
Smn_array=[Smn_array[-1], Smn_array[-2], Smn_array[-3], Smn_array[-4], Smn_array[-5],  Smn_array[-6],
           Smn_array[-7], Smn_array[-8], Smn_array[-9], Smn_array[-10],  Smn_array[-11]]
...
R_p = firing_rates([spikes_t_p], [spikes_i_p], time_array = S1['time_arr'], tau_s = 100*ms, N_total = N_neuron)
rates_p = R_p[0][0]
fig4 = plt.figure()
...
R_n = firing_rates([spikes_t_n], [spikes_i_n], time_array = S1['time_arr'], tau_s = 100*ms, N_total = N_neuron)
rates_n = R_n[0][0]
