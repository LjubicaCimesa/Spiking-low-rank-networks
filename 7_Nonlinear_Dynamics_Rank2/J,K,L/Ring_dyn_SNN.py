...
filename = 'Ring_SNN_spikes'
filerates = 'Ring_SNN_rates'
if redo_spikes:
    # print(redo_spikes)
...
plt.plot(time_array[time_cond], np.mean(R_all[0]['Rates'][0][ind_ex][time_cond, :],axis=1), color = color_list[ind_ex])
plt.ylim([0,100])
