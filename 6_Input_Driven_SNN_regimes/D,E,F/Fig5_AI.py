...
# proj_I_a1 = np.dot(rates_a1[0][0], vector_I_a[0])/N
# proj_m_a1 = np.dot(rates_a1[0][0], vector_m_a[0])/N
...
# proj_I_a2 = np.dot(rates_a2[0][0], vector_I_a[0])/N
# proj_m_a2 = np.dot(rates_a2[0][0], vector_m_a[0])/N
